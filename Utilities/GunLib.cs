...
namespace Undefined.Utilities
{
    ...
    {
        public static Variables GunConfig = new Variables();
        ...
        private static AnimationMode currentAnimationMode = AnimationMode.Wave;
        ...
        public static void StartPcGun(Action action, bool LockOn)
        {
            ...
            if (flag && spherepointer == null)
            {
                ...
                GunLibCoroutineHelper helper = spherepointer.AddComponent<GunLibCoroutineHelper>();
                helper.StartCoroutine(PulsePointer(spherepointer));
            ...
            GunLibCoroutineHelper helper2 = lineObject.AddComponent<GunLibCoroutineHelper>();
            helper2.StartCoroutine(StartCurvyLineRenderer(lineRenderer, GorillaTagger.Instance.rightHandTransform.position, lr, spherepointer.transform.position, GunConfig.LineColorStart, GunConfig.LineColorEnd));
            helper2.StartCoroutine(AnimateLineGradient(lineRenderer, GunConfig.LineColorStart, GunConfig.LineColorEnd));
        ...
        private static void HandleLineRendering()
        {
            ...
            GunLibCoroutineHelper helper = lineObject.AddComponent<GunLibCoroutineHelper>();
            helper.StartCoroutine(StartCurvyLineRenderer(lineRenderer, GorillaTagger.Instance.rightHandTransform.position, lr, spherepointer.transform.position, GunConfig.LineColorStart, GunConfig.LineColorEnd));
            helper.StartCoroutine(AnimateLineGradient(lineRenderer, GunConfig.LineColorStart, GunConfig.LineColorEnd));
        ...
        public static void ToggleParticles()
        {
            ...
            {
                GunLibCoroutineHelper helper = spherepointer.AddComponent<GunLibCoroutineHelper>();
                helper.StartCoroutine(SmoothStopParticles());
            }
        }
        ...
        public static void BoxESP()
        {
            ...
            GunLibCoroutineHelper helper = boxObject.AddComponent<GunLibCoroutineHelper>();
            helper.StartCoroutine(AnimateBox(boxObject, lineRenderer2));
        ...
        public static string currentLineStyle = "Wave";
        ...
        public static void ResetGunDefaults()
        {
            GunLineWidth = 0.03f;
            SphereSize = 0.2f;
            currentAnimationMode = AnimationMode.Wave;
            currentLineStyle = currentAnimationMode.ToString();
    ...
    public class GunLibCoroutineHelper : MonoBehaviour
    {
